<%@ Page Language="C#" MasterPageFile="~/prodCat.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="WebApplication.Admin.Contact.Edit" %>
...
<asp:Content ID="cHeadContent" ContentPlaceHolderID="cphHeadContent" Runat="Server"> 
    ...
    <script type="text/javascript">
    	...
    	function InitializeEventBindings() {
    	    ...
    	    $("[id*=lnkAddPhone]").click(function () {
    	        ClearPhoneForm();
    	        RevealPhonePanel();
    	    });

    	    $("[id*=lnkCancelPhone]").click(function () {
    	        $("[id*=phoneForm]").slideToggle(250);
    	        $("[id*=phoneToggle]").toggleClass('plus').toggleClass('minus');
    	        $("[id*=lnkAddPhone]").html('Add Phone');
    	        $("[id*=btnPhoneSubmit]").attr('value', 'Add Phone');
    	        ClearPhoneForm();
    	    });
...
//    	    // Add '902-' to textbox on focus
//    	    $("[id*=tbPhoneNumber]").focus(function () {
//    	        if ($(this).val() == "") {
//    	            $(this).val('902-');
//    	        }
//    	    });
        ...
        function RevealPhonePanel() {
        	if ($("[id*=phoneForm]").is(':hidden')) {
        		$("[id*=phoneToggle]").toggleClass('plus').toggleClass('minus');
        		$("[id*=phoneForm]").show(250);
        	}
        	return false;
        }
        ...
        function ClearPhoneForm() {
        	$("[id*=ddlPhoneType]").val('');
        	$("[id*=tbPhoneNumber]").val('');
        	$("[id*=tbPhoneComment]").val('').triggerHandler("keyup");

        	$("[id*=hdnPhoneId]").val('');

        	// Hide validator messages.
        	$("[id*=rfvPhone]").css('display', 'none');
        	$("[id*=revPhone]").css('display', 'none');
        }
        ...
        function ConfirmContactDelete() {
        	if ($("[id*=lbDeleteContactTop]").attr("disabled") == "disabled") {
        		return false;
        	}
        	else {
        		return confirm("Are you sure you would like to delete the contact " + $("[id*=tbFirstName]").val() + " " + $("[id*=tbLastName]").val() + "?");
        	}
        }
     </script>
</asp:Content>
...
<asp:Content ID="cMainContent" ContentPlaceHolderID="cphMainContent" Runat="Server"> 
    <div class="breadcrumb"><a href="~/Admin/Contact/Index.aspx" runat="server">Contact Index</a> &raquo; <strong>Modify Contact</strong></div>
	
    <div class="page_header clearfix">
		<div class="action_btns"><asp:Button ID="btnSubmitTop" runat="server" Text="SAVE" OnClick="btnSubmit_onClick" CssClass="submit_btn" />  | <asp:LinkButton ID="lbDeleteContactTop" runat="server" OnClientClick="return ConfirmContactDelete()" OnClick="lbDeleteContact_onClick">Delete</asp:LinkButton></div>
		<h2 class="page_title">Modify Contact</h2>
	</div>
    ...
    <div class="form_wrap clearfix">
        ...
        <script type="text/javascript" language="javascript">
            ...
            prm.add_endRequest(function () {
                ...
                else if ($("[id*=hdnDisplayAddressForm]").val() == "1") {
                    RevealAddressPanel();
                }

                if ($("[id*=hdnPhoneId]").val() != "") {
                    $("[id*=lnkAddPhone]").html('Edit Phone');
                    $("[id*=btnPhoneSubmit]").attr('value', 'Update Phone');
                    RevealPhonePanel();
                }
        ...
        <act:AutoCompleteExtender ID="aceParentBusiness" runat="server" ServicePath="~/WebServices/Services.asmx" ServiceMethod="GetBusinessNameList" MinimumPrefixLength="3" TargetControlID="tbNewBusinessName" CompletionSetCount="10" ></act:AutoCompleteExtender>
        ...
        <div class="col_wrap clearfix">
            <div class="left_col wide">
                ...
                <div class="form_fields clearfix">
			        <div class="form_label"><label>Parent business</label> </div>
			        <div class="form_input"><asp:Literal ID="litParentBusinessName" runat="server"></asp:Literal></div>
		        </div>
                <div class="form_fields clearfix">
			        <div class="form_label"><label>New parent business</label> </div>
			        <div class="form_input"><asp:TextBox ID="tbNewBusinessName" AutoComplete="Off" AutoPostBack="false" runat="server" CssClass="biz_name_field"></asp:TextBox>
                    <asp:CustomValidator ID="cvNewBusinessName" runat="server" ControlToValidate="tbNewBusinessName"
                        ErrorMessage="The business does not exist." Display="Dynamic" 
                        onservervalidate="cvNewBusinessName_ServerValidate" /></div>
		        </div>
            ...
            <div class="right_col wide">
                <div class="form_fields clearfix">
                 ...
                 <div class="form_fields clearfix">
			        ...
			        <div class="form_input"><asp:TextBox TextMode="MultiLine" ID="tbComment" runat="server" Length="500"></asp:TextBox>
        ...
        <div id="tabs" class="clearfix">
            <div class="form_tabs clearfix">
                <ul class="clearfix">
                    ...
                    <li><a href="#fragment-2"><span class="fr_tab">Phone numbers</span></a></li>
            ...
            <asp:UpdatePanel ID="upAddress" runat="server">
                <ContentTemplate>
					<div class="fieldset">
                        <table border="0" cellpadding="0" cellspacing="0" class="tbl_data">
                            <tr class="tbl_header">
								...
								<td style="width:26%;"><strong>Line 1</strong></td>
								<td style="width:12%;"><strong>City</strong></td>
								<td style="width:12%;"><strong>Prov/Region</strong></td>
								<td style="width:12%;"><strong>Postal code</strong></td>
								<td style="width:12%;"><strong>Country</strong></td>
                    ...
                    <div id="addressForm" class="update_pnl section_body">
                        ...
                        <asp:HiddenField ID="hdnDisplayAddressForm" runat="server" />
                        <div class="form_left">
                        ...
                        <div class="form_right">
                            ...
                            <div class="form_fields clearfix">
                                ...
                                <asp:RegularExpressionValidator ID="revAddressPostalCode" runat="server" ControlToValidate="tbPostalCode" 
                                    ...
                                    ValidationExpression="^[A-Z|a-z]{1}\d{1}[A-Z|a-z]{1}\s?\d{1}[A-Z|a-z]{1}\d{1}|^(\d{5})$|^(\d{5}-\d{4})$" />
		                    </div>
                        </div>
					...
					<div class="fieldset">
						<table border="0" cellpadding="0" cellspacing="0" class="tbl_data">
							...
							<asp:Repeater ID="rptPhone" runat="server">
								<ItemTemplate>
									<tr>
										<td style="width:20%;"><%# Eval("phoneType") %></td>
										<td style="width:65%;"><%# Eval("phoneNumber") %></td>
										<td style="width:15%;"><asp:LinkButton ID="btnEditPhone" CommandArgument='<%# Eval("phoneId") %>' runat="server" Text="Edit" OnClick="btnEditPhone_onClick" /> | <asp:LinkButton ID="btnDeletePhone" CommandArgument='<%# Eval("phoneId") %>' OnClientClick='<%# "return ConfirmDelete(this, \"Are you sure you would like to delete the phone number " + Eval("phoneNumber") + "?\")" %>' runat="server" Text="Delete" OnClick="btnDeletePhone_onClick" /></td>
									</tr>
								</ItemTemplate>
							</asp:Repeater>
						</table>
					</div>
                    <div id="phoneToggle" class="section_toggle plus"><a id="lnkAddPhone">Add Phone</a></div>
                    <div id="phoneForm" class="update_pnl section_body clearfix">
                        <asp:HiddenField ID="hdnPhoneId" runat="server" />
                        <div class="form_left">
							<div class="form_fields clearfix">
								<div class="form_label"><label>Phone type</label> <span class="required">&bull;</span></div>
								<div class="form_input"><asp:DropDownList ID="ddlPhoneType" runat="server"></asp:DropDownList></div>
								<asp:RequiredFieldValidator ID="rfvPhonePhoneType" runat="server" ControlToValidate="ddlPhoneType" 
									ErrorMessage="Phone type is a required field." Display="Dynamic" ValidationGroup="vgPhone" />
							</div>
							<div class="form_fields clearfix">
								<div class="form_label"><label>Phone number</label> <span class="required">&bull;</span></div>
								<div class="form_input"><asp:TextBox ID="tbPhoneNumber" runat="server" MaxLength="100" CssClass="phone_field"></asp:TextBox></div>
								<asp:RequiredFieldValidator ID="rfvPhonePhoneNumber" runat="server" ControlToValidate="tbPhoneNumber" 
									ErrorMessage="Phone number is a required field." Display="Dynamic" ValidationGroup="vgPhone" />
							</div>
						</div>
						<div class="form_right">
							<div class="form_fields clearfix">
								<div class="form_label"><label>Comment</label></div>
								<div class="form_input"><asp:TextBox TextMode="MultiLine" ID="tbPhoneComment" runat="server" Length="500"></asp:TextBox>
                                <p class="chars_remaining">Characters remaining: 500</p></div>
							</div>
						</div>
						<div class="clearboth"></div>
                        <div class="update_btn_bar">
                            <asp:Button ID="btnPhoneSubmit" runat="server" Text="Add Phone" OnClick="btnPhoneSubmit_onClick" CssClass="update_btn" ValidationGroup="vgPhone" /> | <a id="lnkCancelPhone" href="#">Cancel</a>
                        </div>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
					...
					<div class="fieldset">
						<table border="0" cellpadding="0" cellspacing="0" class="tbl_data">
							<tr class="tbl_header">
								...
								<td style="width:20%;"><strong>Community</strong></td>
            ...
            <div id="productForm" class="update_pnl section_body clearfix">
                <div class="form_left">
                    ...
                    <div class="form_fields clearfix">
			            ...
			            <div class="form_input"><asp:Literal ID="litContactName" runat="server"></asp:Literal> </div>
		            </div>
                    <div class="form_fields clearfix">
			            <div class="form_label"><label>Email</label></div>
                ...
                <div class="form_right">
                    <div class="form_fields clearfix">
			            ...
			            <div class="form_input"><asp:TextBox ID="tbProductProprietor" runat="server" MaxLength="50"></asp:TextBox></div>
		            </div>
                    <div class="form_fields clearfix">
			            <div class="form_label"><label>Address 1</label></div>
    ...
    <div class="submit_btn_bar clearfix">
        <asp:Button ID="btnSubmit" runat="server" Text="SAVE" OnClick="btnSubmit_onClick" CssClass="submit_btn" /> | <asp:LinkButton ID="lbDeleteContact" runat="server" OnClientClick="return ConfirmContactDelete()" OnClick="lbDeleteContact_onClick">Delete</asp:LinkButton>
    </div>
