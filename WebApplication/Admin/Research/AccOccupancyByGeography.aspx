<%@ Page Language="C#" MasterPageFile="~/research.master" AutoEventWireup="true" CodeBehind="AccOccupancyByGeography.aspx.cs" Inherits="WebApplication.Admin.Research.AccOccupancyByGeography" %>
...
<asp:Content ID="cHeadContent" ContentPlaceHolderID="cphHeadContent" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("[id*=ddlAccommodationType]").multiselect({
                noneSelectedText: 'Select Accommodation Classes',
                selectedList: 4,
                autoOpen: false
            });
        ...
        function ClearForm() {
            ...
            $("[id*=ddlAccommodationType]").multiselect("uncheckAll");
        ...
        function GenerateReport(formatType) {
            ...
            var accommodationTypes = ($("[id*=ddlAccommodationType]").val()) ? $("[id*=ddlAccommodationType]").val() : "";
...
<asp:Content ID="cMainContent" ContentPlaceHolderID="cphMainContent" Runat="Server"> 
    ...
    <div id="dvAccommodationType" class="form_fields clearfix">
		<div class="form_label"><label>Accommodation Class:</label></div>
		<div class="form_input">
            <asp:DropDownList ID="ddlAccommodationType" runat="server" multiple="multiple">
            </asp:DropDownList>
        </div>
        <div id="dvErrorAccommodationType" style="display:none;">
		    <span style="color:red;">At least one Accommodation Class is required.</span>
       </div>
	</div> 
