<%@ Page Language="C#" MasterPageFile="~/research.master" AutoEventWireup="true" CodeBehind="NonReporting.aspx.cs" Inherits="WebApplication.Admin.Research.NonReporting" %>
...
<asp:Content ID="cHeadContent" ContentPlaceHolderID="cphHeadContent" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GenerateReport(formatType) {
            ...
            var url = 'GenerateResearchReport.aspx?reportTypeId=5' + '&startYear=' + $("[id*=ddlStartYear]").val() + '&startMonth=' + $("[id*=ddlStartMonth]").val() + '&endYear=' + $("[id*=ddlEndYear]").val() + '&endMonth=' + $("[id*=ddlEndMonth]").val() + '&formatTypeId=' + formatType;
            //alert(url);
