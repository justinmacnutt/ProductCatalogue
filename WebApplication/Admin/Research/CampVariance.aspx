<%@ Page Language="C#" MasterPageFile="~/research.master" AutoEventWireup="true" CodeBehind="CampVariance.aspx.cs" Inherits="WebApplication.Admin.Research.CampVariance" %>
...
<asp:Content ID="cHeadContent" ContentPlaceHolderID="cphHeadContent" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GenerateReport(formatType) {
            ...
            var url = 'GenerateResearchReport.aspx?reportTypeId=10' + '&startYear=' + $("[id*=ddlStartYear]").val() + '&startMonth=' + $("[id*=ddlStartMonth]").val() + '&endYear=' + $("[id*=ddlEndYear]").val() + '&endMonth=' + $("[id*=ddlEndMonth]").val() + '&filterByAmount=' + filterByAmount + '&variance=' + variance + '&formatTypeId=' + formatType;
