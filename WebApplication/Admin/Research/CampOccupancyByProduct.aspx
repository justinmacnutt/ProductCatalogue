<%@ Page Language="C#" MasterPageFile="~/research.master" AutoEventWireup="true" CodeBehind="CampOccupancyByProduct.aspx.cs" Inherits="WebApplication.Admin.Research.CampOccupancyByProduct" %>
...
//                }
        ...
        function GenerateProductList() {
            ...
            $.ajax({
                type: "POST",
                url: "CampOccupancyByProduct.aspx/GetProductList",
                data: dataString,
                ...
                success: function (msg) {
                    ...
                    if (myLength > 0) {
                        ...
                        myProductTable += '<tr class="tbl_header"><td style="width:20%;"><strong>License Number</strong></td><td style="width:20%;"><strong>Product Name</strong></td><td style="width:15%;"><strong>Region</strong></td><td style="width:15%;"><strong>Action</strong></td></tr>';
                        //alert(x.length);
...
//                            myProductTable += "<td>" + x[q].accommodationType + "</td>";
        ...
        function AddProduct() {
            ...
            $.ajax({
                type: "POST",
                url: "CampOccupancyByProduct.aspx/AddProduct",
                data: dataString,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
