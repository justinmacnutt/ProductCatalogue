<%@ Page Language="C#" MasterPageFile="~/research.master" AutoEventWireup="true" CodeBehind="CampConfidential.aspx.cs" Inherits="WebApplication.Admin.Research.CampConfidential" %>
...
<asp:Content ID="cHeadContent" ContentPlaceHolderID="cphHeadContent" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("[id*=tbProductName]").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "CampConfidential.aspx/GetProducts",
                        dataType: "json",
                        data: dataString,
        ...
        function GenerateReport(formatType) {
            var url = 'GenerateResearchReport.aspx?reportTypeId=8' + '&years=' + $("[id*=ddlYear]").val() + '&productName=' + encodeURIComponent($("[id*=tbProductName]").val()) + '&licenseNumber=' + encodeURIComponent($("[id*=tbLicenseNumber]").val()) + '&formatTypeId=' + formatType;
            if (formatType == 2) {
        ...
        function PerformServerValidation(formatType) {
            ...
            $.ajax({
                type: "POST",
                url: "CampConfidential.aspx/ValidateForm",
                data: dataString,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
