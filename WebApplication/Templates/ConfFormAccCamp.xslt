  ...
  <xsl:template match="/">
    ...
    <html>
      <head>
        ...
        <title>Accommodation Confirmation Form</title>
        <style type="text/css">
          ...
          <div class="letterPage">
            <div >
              ...
              <div class="disclaimer">
                <strong>These are your current print and web listings on record in our database. <u>Print descriptions will be included only in enhanced listings ($150 plus HST for English, $100 plus HST for French).</u> You may use the existing description or write a new one. The maximum length is 150 characters.</strong>
                <span class="red">
                  ...
                  <tr>
                    ...
                    <td style="padding:10px 0px 0 41px;width:50%;">
                      ...
                      <p>
                        ...
                        <xsl:value-of select="accommodationTypeString"/>
                      </p>
                      <p>
                        <b>Rates</b> (for <xsl:value-of select="$nextYear"/>)<b>: </b> 
                        <xsl:value-of select="rateString"/>
                      </p>
                      <p>
                      ...
                      <p>
                        <b>Off-season by Reservation: </b>
                        <xsl:value-of select="offSeason"/>
                      </p>
                      <p>
                        <b>Payment Options: </b>
              ...
              <div style="margin:12px 4px;">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="icon_list">
                  <tr>
                    <td colspan="2">
                      <h2 class="heading">On-Site Features</h2>
                    </td>
                    <td colspan="2">
                      <h2 class="heading">On-Site Activities</h2>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <ul>
                        <li>
                          <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> Kitchen/Kitchenette (H)
                        </li>
                        <li>
                          <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> <span class="large">W</span> Wireless Internet Access
                        </li>
                        <li>
                          <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> <span class="symbols large">@</span> Wired Internet Access
                        </li>
                        <li>
                          <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> <span class="symbols large">+</span> Indoor Smoking Permitted
                        </li>
                        
                        <li>
                          <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> <span class="symbols large">p</span> Pets Allowed
                        </li>
                        <li>
                          <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> <span class="symbols large">q</span> Pets Not Allowed
                        </li>
                        <li>
                          <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> <span class="symbols large">,</span> Pets On Premises
                        </li>
                      </ul>
                    </td>
                    <td>
                      <ul>
                        ...
                        <li>
                          <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> Cable or Sat TV
                        </li>
                        <li>
                          <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> Private Bathroom
                        </li>
                        <li>
                          <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> Ensuite Bathroom
                        </li>
                        <li>
                          <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> Shared Bathroom
                        </li>
                      </ul>
                    </td>
                    <td>
                ...
                <h2 class="heading">Print Description <small style="font-weight:normal;">(enhanced listing only; will be edited to fit if needed)</small></h2>
