  ...
  <xsl:template match="/reportFile">
    <html>
      <head>
        ...
        <style type="text/css">
          div.letterPage   { position:relative; top:0; left:0; width:1918px; height:1230px; vertical-align:top; font-size:15px; font-family:arial,sans-serif; color:#000000; font-weight:normal; line-height:normal; letter-spacing:-0.2px; overflow:hidden;  }
      ...
      <body style="background-color:#fff;margin:0;padding:0;">
        <div class="letterPage">
          <h4>
            ...
            Campground Occupancy by License Number Report<br/><br/>
          </h4>
            ...
            <div class="letterPage">
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="header">
                <tr>
                  ...
                  <td>
                    <span class="bold">Est. Short Term<br/>Sold</span>
                  </td>
                  <xsl:choose>
                    <xsl:when test ="$myDisplayActuals = 'true'">
                      <td>
                  ...
                  <td>
                    <span class="bold">Total Occupancy<br/>Rate</span>
                  </td>
