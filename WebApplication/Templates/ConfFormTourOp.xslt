  ...
  <xsl:template match="/">
    ...
    <html>
      <head>
        ...
        <title>Tour Operator Confirmation Form</title>
        <style type="text/css">
        ...
        <xsl:for-each select="products/product">
          <div class="letterPage">
            ...
            <div style="margin:0 4px 12px;">
              <table cellpadding="0" cellspacing="0" border="0" style="display:table;table-layout:auto;width:100%;">
                <tr>
                  ...
                  <td style="vertical-align:top;padding-left:10px;">
                    <fieldset style="margin-bottom:12px;">
                      <legend>Regions of Operation</legend>
                        ...
                        <tr>
                          <td style="padding-right:20px;">
                            <ul>
                              ...
                              <li>
                                <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> Bras d'Or Lakes Scenic Drive
                              </li>
                              <li>
                                <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> Ceilidh Trail
                              </li>
                              <li>
                                <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> Fleur-de-Lis-Marconi-Metro CB
                              </li>
                              <li>
                          ...
                          <td>
                            <ul>
                              ...
                              <li>
                                <span class="checkbox">&#160;&#160;&#160;&#160;&#160;</span> Fundy Shore &amp; Annapolis Valley
                              </li>
                              <li>
              ...
              <fieldset style="margin-bottom:12px;">
                <legend>
                  Symbols for <b>Outdoor</b> Tours Only:
                </legend>
