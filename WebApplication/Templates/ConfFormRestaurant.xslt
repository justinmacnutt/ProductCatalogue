  ...
  <xsl:template match="/">
    ...
    <html>
      <head>
        ...
        <title>Restaurants Confirmation Form</title>
        <style type="text/css">
      ...
      <body style="background-color:#fff;margin:0;padding:0;">
        <xsl:for-each select="products/product">
          <div class="letterPage">
              ...
              <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                <tr>
                  ...
                  <td style="padding:10px 0px 0 41px;width:50%;">
                    ...
                    <p>
                      <b>Category: </b>
                      <xsl:value-of select="restaurantCategory"/>
                    </p>
                    <p>
                      <b>Specialty: </b>
                      <xsl:value-of select="restaurantSpecialty"/>
                    </p>
                    <p>
                      <b>Seating: </b>
                      Interior: <xsl:value-of select="seatingCapacityInterior"/> / Exterior: <xsl:value-of select="seatingCapacityExterior"/>
                    </p>
                    <p>
            ...
            <div style="margin:24px 4px;line-height: 2em;">
              <h2 class="heading">
