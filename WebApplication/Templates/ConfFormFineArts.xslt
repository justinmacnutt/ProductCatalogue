  ...
  <xsl:template match="/">
    ...
    <html>
      <head>
        ...
        <title>Galleries, Shops, Artists &amp; Artisans Confirmation Form</title>
        <style type="text/css">
      ...
      <body style="background-color:#fff;margin:0;padding:0;">
        <xsl:for-each select="products/product">
          <div class="letterPage">
              ...
              <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                <tr>
                  ...
                  <td style="padding:10px 0px 0 41px;width:50%;">
                    ...
                    <p>
                      <b>Open Studio Artisan: </b>
                      <xsl:value-of select="exhibitType"/>
                    </p>
                    <p>
                      <b>Category: </b>
                      <xsl:value-of select="fineArtsCategory"/>
                    </p>
                    <p>
                      <b>Media: </b>
                      <xsl:value-of select="fineArtsMedia"/>
                    </p>
                    <p>
            ...
            <div style="margin:0 4px 12px;padding-top:4px;">
